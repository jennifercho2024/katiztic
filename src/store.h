...
/* Draw the store on the given floor. `owned` marks furniture you already have
 * (shown as "owned" rather than a price). */
...
/* Hit-test a tap on the store screen for the given floor. */
StoreTap store_hit(StoreFloor floor, float px, float py);
